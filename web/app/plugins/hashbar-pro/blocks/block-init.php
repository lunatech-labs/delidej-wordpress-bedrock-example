...
namespace HashbarPro\Block;

if ( ! defined( 'ABSPATH' ) ) {
	exit;
}

class Hashbar_Pro_Block {
	/**
     * [$_instance]
     * @var null
     */
    ...
    public function block_list(){
    	$blockList = [
            ...
            'hashbar_parentblock' => array(
                'label'  	  => 'Hashbar Others Blocks',
                'file-name'   => 'hashbar-parent-block'
            ),
            'hashbar_socialicon' => array(
                'label'  	  => 'Hashbar Social Icon',
                'file-name'   => 'hashbar-social'
            ),
            'hashbar_button' => array(
                'label'  	  => 'Hashbar Button',
                'file-name'   => 'hashbar-button'
            ),
            'hashbar_paragraph' => array(
                'label'  	  => 'Hashbar Paragraph',
                'file-name'   => 'hashbar-paragraph'
            ),
            'hashbar_paragraph' => array(
                'label'  	  => 'Hashbar Facebook Likebox',
                'file-name'   => 'hashbar-likebox'
            ),
	...
	public function block_editor_assets() {
		...
		wp_enqueue_style( 'hashbar-block-editor-style', HASHBAR_BLOCK_URL . '/src/assets/css/editor-style.css', false, HASHBAR_WPNBP_VERSION, 'all' );
		wp_enqueue_style( 'hashbar-pro-frontend', HASHBAR_WPNBP_URI.'/assets/css/frontend.css', '', time());
		wp_enqueue_script( 'jquery-countdown', HASHBAR_WPNBP_URI.'/assets/js/jquery.countdown.min.js', array('jquery'),HASHBAR_WPNBP_VERSION, true);
