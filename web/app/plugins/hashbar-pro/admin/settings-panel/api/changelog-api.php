<?php
namespace HashbarProChangelog\Api;
    ...
    private function get_changelog_data() {
        return [
            [
                ...
                'changes' => [
                    ...
                    'Improved' => [
                        ...
                        'Pro announcement message markup & KSES aligned with HashBar free.',
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    'Added' => [
                        'Reopen Button Styling section in Design tab with color, font, and border radius controls.',
                    ],
                    'Improved' => [
            ...
            [
                ...
                'changes' => [
                    'Improved' => [
                        'Posts, Pages, and Products list limits now properly connected to Settings.',
                        'Server-side search support for page/post selection in targeting options.',
            ...
            [
                ...
                'changes' => [
                    'Added' => [
                        ...
                        'Flash Sale, Cyber Monday, and Split E-commerce templates for Popup Campaigns.',
            ...
            [
                ...
                'changes' => [
                    'Added' => [
                        'Delay After Click option for On Element Click popup trigger.',
                    ],
                    'Improved' => [
            ...
            [
                ...
                'changes' => [
                    'Added' => [
                        ...
                        'Popup Analytics Dashboard and A/B Testing.',
            ...
            [
                ...
                'changes' => [
                    'Improved' => [
                        'License manager functionality for better experience.'
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    ...
                    'Fixed' => [
                        'Issue with notification bar not showing in private pages.'
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    'Added' => [
                        'Typography options for "Hashbar Notification" block.'
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    ...
                    'Fixed' => [
                        'Issue with social icon block icons list.',
                        'Translation notice issue with WordPress 6.7.1'
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    'Updated' => [
                        '3rd party libraries for latest PHP version compatibility.'
                    ],
                ],
            ],
            [
                ...
                'changes' => [
                    'Fixed' => [
                        'Missing translation issue in plugin options page.'
                    ],
                    'Updated' => [
...
\HashbarProChangelog\Api\ChangeLog::instance();