...
namespace HashbarPro\AnalyticsProcess;
use \HashbarPro\DatabaseInstaller\Database_Installer;
use \HashbarPro\AnalyticsCache\Cash_Data;
...
class Analytical_Process 
{
    ...
    */
    ...
    public function analytics(){
        ...
        $analytics_form          = hashbar_get_opt('analytics_from');
        $should_count            = false;
        ...
        if( $should_count === false || (hashbar_get_opt('count_onece_byip')  && !empty($existing_ip_analytics)) ) {
            wp_die();
        }
        $data_analytics = [
            'post_id'    => $_POST['id'],
