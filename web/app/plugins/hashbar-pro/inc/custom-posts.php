...
*    Register Post type
* =======================================================*/
function hashbar_wpnbp_custom_posts() {
	global $hashbarpro_gutenberg_enable;
	// Notification bars
	$labels = array(
	...
	$args = array(
		...
		'show_in_rest'       	=> $hashbarpro_gutenberg_enable,
...
add_action( 'init', 'hashbar_wpnbp_custom_posts');