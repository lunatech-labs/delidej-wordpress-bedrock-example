<?php
/**
 * Popup Template: Fullscreen Overlay
 *
 * Full-screen takeover popup for maximum impact.
 *
 * @package HashBar
 * @since 2.0.0
 *
...
<div id="hashbar-popup-<?php echo esc_attr( $popup_id ); ?>"
     class="hashbar-popup-campaign hashbar-popup-fullscreen <?php echo esc_attr( $popup_classes ); ?>"
