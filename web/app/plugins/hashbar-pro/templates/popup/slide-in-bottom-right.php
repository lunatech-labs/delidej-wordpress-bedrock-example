<?php
/**
 * Popup Template: Slide-in Bottom Right
 *
 * Non-intrusive slide-in popup from bottom right corner.
 *
 * @package HashBar
 * @since 2.0.0
 *
...
<div id="hashbar-popup-<?php echo esc_attr( $popup_id ); ?>"
     class="hashbar-popup-campaign hashbar-popup-bottom_right <?php echo esc_attr( $popup_classes ); ?>"
