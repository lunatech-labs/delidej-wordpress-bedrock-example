<?php
/**
 * Popup Template: Floating Box
 *
 * Small floating notification box, typically in corner.
 *
 * @package HashBar
 * @since 2.0.0
 *
...
<div id="hashbar-popup-<?php echo esc_attr( $popup_id ); ?>"
     class="hashbar-popup-campaign hashbar-popup-floating <?php echo esc_attr( $popup_classes ); ?>"
