<?php
/**
 * Popup Template: Left Side Panel
 *
 * Full-height side panel sliding in from the left.
 *
 * @package HashBar
 * @since 2.0.0
 *
...
<div id="hashbar-popup-<?php echo esc_attr( $popup_id ); ?>"
     class="hashbar-popup-campaign hashbar-popup-side_left <?php echo esc_attr( $popup_classes ); ?>"
